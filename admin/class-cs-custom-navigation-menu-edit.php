<?php
/**
 * CS Nav Walker: CSNW_Nav_Menu_Edit class
 *
 ...
 */
class CSNW_Nav_Menu_Edit extends Walker_Nav_Menu
{
	...
	<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes); ?>">
		...
		<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
			...
			<div class="menu-item-actions description-wide submitbox">
				...
				<a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url(add_query_arg(['edit-menu-item' => $item_id, 'cancel' => time()], admin_url('nav-menus.php')));
